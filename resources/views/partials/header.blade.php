    ...
    <nav aria-label="top">
        ...
        <div class="bg-black bg-opacity-20">
            <x-container.boxed class="">
                ...
                <!-- Mobile menu (lg-) -->
                <div class="grid grid-cols-5 flex items-center h-full">
                    <!-- Left -->
                    <ul class="flex justify-between items-center h-full col-span-2">
                        <li class="flex justify-center items-center group w-full h-full border-transparent border-b-2 hover:border-gold-500 hover:bg-black hover:bg-opacity-10">
                    ...
                    <div class="relative col-span-1">
                        <img src="{{ asset('images/logo/img.png') }}" class="absolute left-1/2 transform -translate-x-1/2 mt-[-80px]  h-[15.5rem]" alt="Logo"/>
                    </div>

                    <!-- Right -->
                    <ul class="flex justify-between col-span-2">
